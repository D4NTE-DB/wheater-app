...
function App() {
  ...
  useEffect(() => {
    axios.get("https://api.openweathermap.org/data/2.5/weather?lat=8.81389&lon=-74.7253&appid=fb1498a695ea5f0a691f13584fe86041&units=metric").then(res => setData(res.data),)
  }, [])
